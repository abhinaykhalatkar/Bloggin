<template>
  <div class="heading">
    <h1> I like to reinvent myself</h1>

    <div class="mb-1 text-muted dateposted">Posted On July 31,2022</div>
    <br/>
    <p class="card-text mb-6">In this series of articles I want to share with you how I got into the world of
      programming. I never went to university to study IT, but I found a way around it. If you like the series and
      want to see a book out of this, please leave a comment below.</p>
  </div>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item">
          <img class="first-slide" src="@/assets/Screen2Assets/Template1.jpg" alt="First slide">
          <div class="container">
        ...
        <div class="carousel-item active">
          <img class="third-slide" src="@/assets/Screen2Assets/Technology1.jpg" alt="Third slide">
          <div class="container">
...
Ever so delicately traced the shore on our left was densely wooded, and the som ber shadow that fell from this forest was broken in one place by a long, ruffled trail that shone like silver and high above the forest wall. 
There were graceful curves, reflected images, woody on the heights, soft distances and over the whole scene far and so near, the dissolving lights drifted steadily now dissolving lights.
...
<div>
  ...
  <img class="template3" :src="require('@/assets/Screen2Assets/Technology2.jpg')" alt="Placeholder image">
</div>
